...
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableArrayValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableBigIntegerValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableBinaryValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableBooleanValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableDoubleValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableExtensionValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableLongValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableMapValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableNilValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableStringValueImpl;
import dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.value.impl.ImmutableTimestampValueImpl;
