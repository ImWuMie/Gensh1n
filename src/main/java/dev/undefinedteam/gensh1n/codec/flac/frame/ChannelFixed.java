...
import dev.undefinedteam.gensh1n.codec.flac.FixedPredictor;
...
public class ChannelFixed extends Channel {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("FLACSubframe_Fixed: Order=" + order + " PartitionOrder=" + entropyCodingMethod.order + " WastedBits=" + wastedBits);
