package dev.undefinedteam.gensh1n.codec.flac.frame;
...
import dev.undefinedteam.gensh1n.codec.flac.ChannelData;
import dev.undefinedteam.gensh1n.codec.flac.FrameDecodeException;
import dev.undefinedteam.gensh1n.codec.flac.LPCPredictor;
import dev.undefinedteam.gensh1n.codec.flac.io.BitInputStream;
import dev.undefinedteam.gensh1n.codec.flac.util.BitMath;
...
public class ChannelLPC extends Channel {
    ...
    public String toString() {
        ...
        sb.append("\n\t\tParameter: ");
        for (int i = 0; i < (1 << entropyCodingMethod.order); i++) sb.append(entropyCodingMethod.contents.parameters[i] + " ");
        //sb.append("\n\t\tResidual: ");
