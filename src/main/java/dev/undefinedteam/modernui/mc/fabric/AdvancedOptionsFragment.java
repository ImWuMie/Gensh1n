...
public class AdvancedOptionsFragment extends Fragment {
    ...
    LinearLayout createPage(Context context) {
        ...
        {
            var category = PreferencesFragment.createCategoryList(context, "Developer");

            if (ModernUIMod.isDeveloperMode()) {
                {
                    var option = PreferencesFragment.createInputBox(context, "Gamma");
            ...
            {
                var layout = PreferencesFragment.createSwitchLayout(context, "Show Layout Bounds");
