...
import dev.undefinedteam.modernui.mc.DashboardFragment;
import dev.undefinedteam.modernui.mc.ModernUIMod;
import dev.undefinedteam.modernui.mc.MusicFragment;
import dev.undefinedteam.modernui.mc.MarkdownFragment;
...
public class CenterFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // TITLE
        {
            ...
            title.setText(I18n.translate("modernui.center.title"));
    ...
    private RadioButton createNavButton(int id, String text) {
        ...
        button.setId(id);
        button.setText(I18n.translate(text));
