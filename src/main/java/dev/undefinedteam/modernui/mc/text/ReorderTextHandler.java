...
class ReorderTextHandler {
    ...
    // composite
    private final CharacterVisitor mSink = new CharacterVisitor() {
     ...
     */
    public boolean handle(@Nonnull OrderedText sequence, IConsumer consumer) {
