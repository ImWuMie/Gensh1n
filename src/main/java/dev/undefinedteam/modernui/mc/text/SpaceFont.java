...
/**
 * @see net.minecraft.client.font.SpaceFont
 */
public class SpaceFont implements Font {
    ...
    private SpaceFont(String fontName, Int2FloatOpenHashMap advances, float fontSize) {
        mFontName = fontName;
    ...
    @Nonnull
    public static SpaceFont create(Identifier fontName, net.minecraft.client.font.SpaceFont.Loader definition,float size) {
