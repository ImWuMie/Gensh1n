...
public class FormattedLayoutKey {
    ...
    /**
     * Texts use String as their backing store, none of them contains {@link} codes.
     */
    ...
    public static class Lookup extends FormattedLayoutKey {
        ...
        private final ObjectArrayList<Identifier> mFonts = new ObjectArrayList<>();
         ...
         */
        private class ContentBuilder implements StringVisitable.StyledVisitor<Object> {
            @Nonnull
            @Override
         ...
         *
         */
        private class SequenceBuilder implements CharacterVisitor {
         ...
         */
        @Nonnull
        public FormattedLayoutKey update(@Nonnull StringVisitable text, @Nonnull Style style) {
            reset();
         ...
         */
        @Nonnull
        public FormattedLayoutKey update(@Nonnull OrderedText sequence) {
            reset();
