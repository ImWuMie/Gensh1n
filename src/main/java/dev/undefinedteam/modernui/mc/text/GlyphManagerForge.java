...
public class GlyphManagerForge {
    ...
    public static class VanillaGlyph {
        ...
        public void drawGlyph(@Nonnull VertexConsumer builder, float x, float y, int r, int g, int b, int a) {
            ...
            x += baselineX;
            y += baselineY;
            builder.vertex(x, y, 0).color(r, g, b, a).texture(u1, v1)
                .next();
            builder.vertex(x, y + height, 0).color(r, g, b, a).texture(u1, v2)
                .next();
            builder.vertex(x + width, y + height, 0).color(r, g, b, a).texture(u2, v2)
                .next();
            builder.vertex(x + width, y, 0).color(r, g, b, a).texture(u2, v1)
                .next();
        }

        public void drawGlyph(Matrix4f matrix, @Nonnull VertexConsumerProvider buffer, float x, float y, int r, int g,
            ...
            x += baselineX;
            y += baselineY;
            builder.vertex(matrix, x, y, 0).color(r, g, b, a).texture(u1, v1).light(packedLight)
                .next();
            builder.vertex(matrix, x, y + height, 0).color(r, g, b, a).texture(u1, v2).light(packedLight)
                .next();
            builder.vertex(matrix, x + width, y + height, 0).color(r, g, b, a).texture(u2, v2).light(packedLight)
                .next();
            builder.vertex(matrix, x + width, y, 0).color(r, g, b, a).texture(u2, v1).light(packedLight)
                .next();
        }
