...
/**
 * ContainerMenuView can be used to display and interact with a {@link ScreenHandler ContainerMenu}
 * in the view system.
 */
//TODO WIP
public class ContainerMenuView extends View implements CustomDrawable {

    private ScreenHandler mContainerMenu;
    ...
    public void setContainerMenu(ScreenHandler containerMenu) {
