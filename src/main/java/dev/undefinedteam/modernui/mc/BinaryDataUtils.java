...
/**
 * Contains {@link DataSet} and {@link} utilities.
 */
public final class BinaryDataUtils {
     ...
     */
    @Nonnull
    public static PacketByteBuf writeDataSet(@Nonnull PacketByteBuf buf, @Nullable DataSet source) {
     ...
     */
    @Nullable
    public static DataSet readDataSet(@Nonnull PacketByteBuf buf, @Nullable ClassLoader loader) {
